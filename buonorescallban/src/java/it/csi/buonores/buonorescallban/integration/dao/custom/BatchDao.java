...
import it.csi.buonores.buonorescallban.dto.custom.ModelRichiestaBatch;
import it.csi.buonores.buonorescallban.exception.DatabaseException;
import it.csi.buonores.buonorescallban.integration.dao.utils.RichiesteBatchMapper;
...
public class BatchDao extends LoggerUtil {
	...
	public static final String SELECT_BATCH ="SELECT batch_id FROM bres_d_batch a,bres_d_batch_gruppo b "
			...
			+ "and b.batchgruppo_cod='CALLBACK_BANDI'";
	...
	public static final String SELECT_BATCH_PARAMETRO ="SELECT batchparam_valore "
			...
			+ "and c.batchgruppo_cod='SERVIZIO_BO'";
	...
	public static final String SELECT_ESISTE_RECORD_AVVIATO_KO ="select batchesec_id from bres_t_batch_esecuzione a, bres_d_batch_stato b,"
			...
			+ "and d.batchgruppo_cod ='SERVIZIO_BO' "
	...
	public Integer selectEsitoPositivo(ModelRichiestaBatch richiesta,String batchesecdetStep) throws DatabaseException {
		Integer valorint = 0;
		SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("sportello_id", richiesta.getSportelloId())
				.addValue("domanda_id", richiesta.getDomandaId()).addValue("domanda_det_id", richiesta.getDomandaDetId())
	...
	public Long selectEsisteAvviatoKo(String batchesecstatoCod,ModelRichiestaBatch richiesta, String batchCod) throws DatabaseException {

		SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("batchesecstato_cod", batchesecstatoCod)
				.addValue("sportello_id", richiesta.getSportelloId())
				.addValue("domanda_id", richiesta.getDomandaId()).addValue("domanda_det_id", richiesta.getDomandaDetId()).addValue("batch_cod", batchCod);
		try {
	...
	public Long selectEsisteAvviatoOk(String batchesecstatoCod,ModelRichiestaBatch richiesta, String batchCod) throws DatabaseException {
	...
	public Integer selectBatchPrametro(String batchCod, String batchparamCod ) throws DatabaseException {
		String result = null;
		SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("batch_cod", batchCod).addValue("batchparam_cod", batchparamCod);
		try {
	...
	public Integer selectNumeroTentativiKO(ModelRichiestaBatch richiesta, String batchmotivoCod, String batchCod) throws DatabaseException {
		Integer valorint = 0;
		SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("sportello_id", richiesta.getSportelloId())
				.addValue("domanda_id", richiesta.getDomandaId()).addValue("domanda_det_id", richiesta.getDomandaDetId()).addValue("batchmotivo_cod",batchmotivoCod)
	...
	public Integer selectNumeroTentativiOK(ModelRichiestaBatch richiesta, String batchmotivoCod, String batchCod) throws DatabaseException {
		Integer valorint = 0;
		SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("sportello_id", richiesta.getSportelloId())
				.addValue("domanda_id", richiesta.getDomandaId()).addValue("domanda_det_id", richiesta.getDomandaDetId()).addValue("batchmotivo_cod",batchmotivoCod)
				.addValue("batchCod",batchCod);
	...
	public ModelRichiestaBatch selectDomandaBatch(String numeroDomanda) throws DatabaseException {
		...
		try {
			...
			richiesta = jdbcTemplate.queryForObject(SELECT_DATI_DOMANDA_BATCH, namedParameters, new RichiesteBatchMapper());
			return richiesta;
		}	catch (EmptyResultDataAccessException e) {
				return null; 
		}  catch (Exception e) {
	...
	public void UpdateBatchEsecuzioneOK(int tentativi,ModelRichiestaBatch datiDomanda, Long batchId, Long statoId, Long motivoId, String utente) throws DatabaseException{
		
		SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("batchesec_tentativo_numero", tentativi).addValue("utente_modifica", utente)
				.addValue("sportello_id", datiDomanda.getSportelloId())
				.addValue("domanda_id", datiDomanda.getDomandaId()).addValue("domanda_det_id", datiDomanda.getDomandaDetId())
				.addValue("batch_id", batchId).addValue("batchesecstato_id", statoId).addValue("batchmotivo_id", motivoId);
		try {
...
public void UpdateBatchEsecuzioneKO(int tentativi,ModelRichiestaBatch datiDomanda, Long batchId, Long statoId, Long motivoId, String utente) throws DatabaseException{
 ...
 public long SelectBatchEsecuzioneOK(ModelRichiestaBatch datiDomanda, Long batchId, Long statoId, Long motivoId) throws DatabaseException{
	
	 SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("sportello_id", datiDomanda.getSportelloId())
				.addValue("domanda_id", datiDomanda.getDomandaId()).addValue("domanda_det_id", datiDomanda.getDomandaDetId())
				.addValue("batch_id", batchId).addValue("batchesecstato_id", statoId).addValue("batchmotivo_id", motivoId);
 ...
 public long SelectBatchEsecuzioneKO(ModelRichiestaBatch datiDomanda, Long batchId, Long statoId, Long motivoId) throws DatabaseException{
	...
	public void DeleteRecordDaCancellareDuplicati() throws DatabaseException {
		...
		try {
			...
			List<Long> elencobatchid = jdbcTemplate.queryForList(SELECT_RECORD_DUPLICATI_KO,namedParameters,Long.class);
