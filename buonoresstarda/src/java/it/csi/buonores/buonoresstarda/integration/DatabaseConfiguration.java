...
******************************************************************************/
package it.csi.buonores.buonoresstarda.integration;
...
import it.csi.buonores.buonoresstarda.util.BuonoResStardaProperties;
...
public class DatabaseConfiguration {
	...
	@Autowired
	BuonoResStardaProperties properties;
	...
	@Bean
	public PlatformTransactionManager dbTransactionManager(@Qualifier("buonoresDataSource") DataSource buonoresDataSource) {
