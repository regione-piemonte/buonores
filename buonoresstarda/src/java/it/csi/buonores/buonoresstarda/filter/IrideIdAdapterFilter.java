...
******************************************************************************/
package it.csi.buonores.buonoresstarda.filter;
...
import it.csi.buonores.buonoresstarda.dto.UserInfo;
...
public class IrideIdAdapterFilter implements Filter {
	...
	public String getToken(HttpServletRequest httpreq) {
		String marker = (String) httpreq.getHeader(Constants.SHIB_IRIDE_IDENTITADIGITALE);
	...
	private String getTokenDevMode(HttpServletRequest httpreq) {
		String marker = (String) httpreq.getParameter(Constants.SHIB_IRIDE_IDENTITADIGITALE);
		return marker;
	}
