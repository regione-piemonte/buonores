...
public interface InterrogaMefEsenredd1Soap {
    ...
    @RequestWrapper(localName = "InterrogaMefEsenredd", targetNamespace = "http://InterrogaMefEsenredd.central.services.auraws.aura.csi.it", className = "it.csi.buonores.buonoresbff.anagraficaservice.InterrogaMefEsenredd")
    @ResponseWrapper(localName = "InterrogaMefEsenreddResponse", targetNamespace = "http://InterrogaMefEsenredd.central.services.auraws.aura.csi.it", className = "it.csi.buonores.buonoresbff.anagraficaservice.InterrogaMefEsenreddResponse")
