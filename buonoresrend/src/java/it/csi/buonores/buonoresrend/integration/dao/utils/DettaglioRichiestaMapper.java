...
import it.csi.buonores.buonoresrend.dto.ModelBozzaRichiestaDomicilioDestinatario;
import it.csi.buonores.buonoresrend.dto.ModelPersona;
import it.csi.buonores.buonoresrend.dto.ModelProtocollo;
import it.csi.buonores.buonoresrend.dto.ModelRichiesta;
import it.csi.buonores.buonoresrend.dto.ModelRichiestaContratto;
import it.csi.buonores.buonoresrend.dto.ModelStruttura;
import it.csi.buonores.buonoresrend.dto.ModelStrutturaSedeLegale;
...
public class DettaglioRichiestaMapper implements RowMapper<ModelRichiesta> {
	...
	public ModelRichiesta mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		protocollo.setData(Util.getDataWithoutTime(rs.getString("data_protocollo"), Constants.DATE_FORMAT));
...
//		intestatario.setDataNascita(Util.getData(rs.getString("datore_di_lavoro_nascita_data"), Constants.DATE_FORMAT_PATTERN));
