...
public interface SmistaDocumentoPartenzaApi  {
   ...
   public Response smistaDocumentoPartenza(@PathParam("numero_richiesta") String numeroRichiesta,@PathParam("tipo_lettera") String tipoLettera,@HeaderParam("Shib-Identita-CodiceFiscale") String shibIdentitaCodiceFiscale,@HeaderParam("X-Request-Id") String xRequestId,@HeaderParam("X-Forwarded-For") String xForwardedFor,@HeaderParam("X-Codice-Servizio") String xCodiceServizio,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
